...
def make_Multiwfn_as_NWChem_AO_index_permutation_matrix(moldenFile, dim = 1):
    ao_index = []
...
def make_NWChem_as_Multiwfn_AO_index_permutation_matrix(moldenFile, dim = 1):
    ao_index = []
    with open(moldenFile, 'r') as moldenF:
        count = -1
        for line in moldenF:
