import numpy as np
from src.make_NWChem_Multiwfn_AO_index_permutation_matrix import make_NWChem_as_Multiwfn_AO_index_permutation_matrix
...
def make_Rw(elecX, elecY, elecZ, magX, magY, magZ, moldenTemplate):
    ...
    dim = 2
    permMatrix = make_NWChem_as_Multiwfn_AO_index_permutation_matrix(moldenTemplate, dim)
